package com.example.mvpdemo0602.activities;
 ...
 */
public class ViewFinderView1 extends RelativeLayout implements IViewFinder {
    ...
    public synchronized void updateFramingRect() {
        ...
        framingRect = new Rect(left, top, left + width, top+width/*top + height*/);
    }

...
import com.example.mvpdemo0602.activities.SimpleScannerActivity;
...
public class Main2Activity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.main_menu_action_qrcode:
                startActivity(new Intent(Main2Activity.this, SimpleScannerActivity.class));

                return true;
            case R.id.main_menu_action_settings:
                MyApplication.showToast("this is a settings");
                return true;
        }
